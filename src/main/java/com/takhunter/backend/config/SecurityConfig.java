        ...
        http
                ...
                .exceptionHandling(exception -> exception
                        .accessDeniedHandler((request, response, accessDeniedException) -> {
                            ...
                            response.getWriter().write("{\"message\":\"Akses ditolak. Role akun tidak memiliki izin untuk endpoint ini.\"}");
                        })
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.POST, "/api/pendaftaran").hasAuthority("ROLE_MAHASISWA")
                        .requestMatchers(HttpMethod.GET, "/api/pendaftaran/saya").hasAuthority("ROLE_MAHASISWA")
                        .requestMatchers("/api/bookmark/**").hasAuthority("ROLE_MAHASISWA")
                        ...
                        .requestMatchers("/api/eo/notifikasi", "/api/eo/notifikasi/**").hasAuthority("ROLE_EVENT_ORGANIZER")
